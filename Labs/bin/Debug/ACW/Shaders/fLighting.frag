...
uniform sampler2D uTextureSampler[4];
...
void main()
{
      ...
      for(int i = 0; i < 3; ++i)
      {
            ...
            diffuseFactor + uLight[i].SpecularLight * uMaterial.SpecularReflectivity * specularFactor, 1) * texture(uTextureSampler[textureSelect], oTexCoords);
      }
}